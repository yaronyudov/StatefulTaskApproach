...
// NOTE THIS IS NOT FOR MVP BUT AI CODED IT ALREADY
/// <summary>
...
/// </summary>
public sealed class KafkaDeltaConsumer(IOptions<KafkaOptions> options, IDeltaHandler handler, ILogger<KafkaDeltaConsumer> logger)
    : BackgroundService
{
    ...
    private void ConsumeLoop(CancellationToken stoppingToken)
    {
        ...
        consumer.Subscribe(options.Value.DeltaTopic);
        logger.LogInformation("Delta consumer subscribed to {Topic}.", options.Value.DeltaTopic);
